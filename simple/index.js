AFRAME.registerComponent("gaussian_splatting", {
    ...
    vertexShader: `
                ...
                vec4 projectSplat(
                    ...
                    vec2 ndcXY = vCenter + (quadPos.x * v2 + quadPos.y * v1) * viewportInv;
                ...
                void main() {
                    ...
                    #ifdef IS_MULTIVIEW
                    if (gl_ViewID_OVR == 0u) {
                        curPos = projectSplat(gsProjectionMatrix, gsModelViewMatrix, viewRotationMatrix, centerAndScaleData, covAndColorData, quadPos);
                    } else {
                        curPos = projectSplat(gsProjectionMatrixRight, gsModelViewMatrixRight, viewRotationMatrix, centerAndScaleData, covAndColorData, quadPos);
                    }
                    #else
                    curPos = projectSplat(gsProjectionMatrix, gsModelViewMatrix, viewRotationMatrix, centerAndScaleData, covAndColorData, quadPos);
                    #endif
            ...
            fragmentShader: `
                ...
                void main() {
                    ...
                    // The exact same single discard as your motion shader
                    if (len2 > 0.5) discard;

                    // Output pure color (alpha forced to 1.0)
