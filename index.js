			...
			mesh.material.uniforms.gsProjectionMatrix.value = projectionMatrix;
                ...
                this.worker.onmessage = (e) => {
                        if (e.data.method === "sort") {
                                ...
                                this.sortReady = true;
                                if (e.data.fadeUpdated) this.fadeOpacityTexture.needsUpdate = true;
                                ...
                                this.fadeOpacityTexture.image.data = this.fadeOpacityData;
                                this.fadeOpacityTexture.needsUpdate = true;
                        }
                };
                this.sortReady = true;
	...
	getModelViewMatrix: function (camera) {
        ...
        createWorker: function (self) {
				...
				if (!insideOfScreen && !skipCullEdges) continue;
                                ...
                                const edgeMultiplier = 1.0 + (edgeDist * 10.6);
