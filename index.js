AFRAME.registerComponent("gaussian_splatting", {
	...
	initGL: function (camera, object, renderer) {
		...
		this.object = object;
                ...
                this.splatTextureSize = Math.min(8192, maxTextureSize);
		...
		baseGeometry.setIndex(new THREE.BufferAttribute(idx, 1));
			...
			vertexShader: `
				...
				void main() {
					ivec2 texPos = ivec2(int(splatIndex % splatTextureSize), int(splatIndex / splatTextureSize));
