AFRAME.registerComponent("gaussian_splatting", {
	...
	initGL: function (camera, object, renderer) {
		...
		positions.setXYZ(0, -5.0, -5.0, 0.0);
                positions.setXYZ(1, 5.0, -5.0, 0.0);
                positions.setXYZ(2, 0.0,  5.0, 0.0);
	...
	getModelViewMatrix: function (camera) {
        ...
        createWorker: function (self) {
			...
			const cellH = 2.0 / gridSizeY;
                        const cellDiag2 = (cellW*cellW + cellH*cellH) * 0.25;
                        ...
                        for (let j = depthIndex.length - 1; j >= 0; j--) {
                         	...
                         	if (ndcZ < -1.0 || ndcZ > 1.0 ||
                                ...
                                const rX = ndcRadius * gridSizeX;
                                const rY = ndcRadius * gridSizeY;
