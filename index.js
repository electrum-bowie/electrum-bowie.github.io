        ...
        createSortWorker: function (self) {
                ...
                self.onmessage = (e) => {
                        if (e.data.method === "sort") {
                                ...
                                self.postMessage({ method: "sort", sortedIndexes: result.buffer }, [result.buffer]);
                        }
                };
        },
