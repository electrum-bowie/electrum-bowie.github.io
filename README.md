...
and adjusts the XR framebuffer scale when in VR. Use the `autoPixelRatio`
and `targetFps` properties on the `gaussian_splatting` component to
adjust or disable this behaviour.
